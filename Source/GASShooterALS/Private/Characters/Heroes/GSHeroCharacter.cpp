...
#include "GASShooterALS/GASShooterALSGameModeBase.h"
...
AGSHeroCharacter::AGSHeroCharacter(const class FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	UIFloatingStatusBarClass = StaticLoadClass(UObject::StaticClass(), nullptr, TEXT("/Game/GASShooterALS/UI/UI_FloatingStatusBar_Hero.UI_FloatingStatusBar_Hero_C"));
...
void AGSHeroCharacter::FinishDying()
{
	...
	AGASShooterALSGameModeBase* GM = Cast<AGASShooterALSGameModeBase>(GetWorld()->GetAuthGameMode());
...
void AGSHeroCharacter::BeginPlay()
{
	...
	StartingFirstPersonMeshLocation = GetMesh()->GetRelativeLocation();
...
void AGSHeroCharacter::SetCurrentWeapon(AGSWeapon* NewWeapon, AGSWeapon* LastWeapon)
{
	...
	if (NewWeapon)
	{
		...
		if (Equip1PMontage && GetMesh())
		{
			GetMesh()->GetAnimInstance()->Montage_Play(Equip1PMontage);
		}
...
void AGSHeroCharacter::ClearHeldObject()
{
...
void AGSHeroCharacter::AttachToHand(UStaticMesh* NewStaticMesh, USkeletalMesh* NewSkeletalMesh, UClass* NewAnimClass,
...
void AGSHeroCharacter::RagdollStart()
{
	ClearHeldObject();
	Super::RagdollStart();
}

void AGSHeroCharacter::RagdollEnd()
{
	Super::RagdollEnd();
	UpdateHeldObject();
}

ECollisionChannel AGSHeroCharacter::GetThirdPersonTraceParams(FVector& TraceOrigin, float& TraceRadius)
{
...
FTransform AGSHeroCharacter::GetThirdPersonPivotTarget()
{
...
FVector AGSHeroCharacter::GetFirstPersonCameraTarget()
{
