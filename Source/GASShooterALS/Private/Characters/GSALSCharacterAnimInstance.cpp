...
void UGSALSCharacterAnimInstance::NativeInitializeAnimation()
{
	Super::NativeInitializeAnimation();
	Character = Cast<AGSCharacterBase>(TryGetPawnOwner());
}

void UGSALSCharacterAnimInstance::NativeBeginPlay()
{
	...
	{
		ALSDebugComponent = Owner->FindComponentByClass<UGSALSDebugComponent>();
	}
}

void UGSALSCharacterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::PlayTransition(const FALSDynamicMontageParams& Parameters)
{
...
void UGSALSCharacterAnimInstance::PlayTransitionChecked(const FALSDynamicMontageParams& Parameters)
{
...
void UGSALSCharacterAnimInstance::PlayDynamicTransition(float ReTriggerDelay, FALSDynamicMontageParams Parameters)
{
	if (bCanPlayDynamicTransition)
	{
		...
		World->GetTimerManager().SetTimer(PlayDynamicTransitionTimer, this,
		                                  &UGSALSCharacterAnimInstance::PlayDynamicTransitionDelay,
		                                  ReTriggerDelay, false);
	}
}

bool UGSALSCharacterAnimInstance::ShouldMoveCheck() const
{
	return (CharacterInformation.bIsMoving && CharacterInformation.bHasMovementInput) ||
		CharacterInformation.Speed > 150.0f;
}

bool UGSALSCharacterAnimInstance::CanRotateInPlace() const
{
	return RotationMode.Aiming() ||
		CharacterInformation.ViewMode == EALSViewMode::FirstPerson;
}

bool UGSALSCharacterAnimInstance::CanTurnInPlace() const
{
...
bool UGSALSCharacterAnimInstance::CanDynamicTransition() const
{
	return GetCurveValue(NAME_Enable_Transition) >= 0.99f;
}

void UGSALSCharacterAnimInstance::PlayDynamicTransitionDelay()
{
	bCanPlayDynamicTransition = true;
}

void UGSALSCharacterAnimInstance::OnJumpedDelay()
{
	InAir.bJumped = false;
}

void UGSALSCharacterAnimInstance::OnPivotDelay()
{
	Grounded.bPivot = false;
}

void UGSALSCharacterAnimInstance::UpdateAimingValues(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::UpdateLayerValues()
{
...
void UGSALSCharacterAnimInstance::UpdateFootIK(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::SetFootLocking(float DeltaSeconds, FName EnableFootIKCurve, FName FootLockCurve,
...
void UGSALSCharacterAnimInstance::SetFootLockOffsets(float DeltaSeconds, FVector& LocalLoc, FRotator& LocalRot)
{
...
void UGSALSCharacterAnimInstance::SetPelvisIKOffset(float DeltaSeconds, FVector FootOffsetLTarget,
...
void UGSALSCharacterAnimInstance::ResetIKOffsets(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::SetFootOffsets(float DeltaSeconds, FName EnableFootIKCurve, FName IKFootBone,
                                               ...
                                               FRotator& CurRotationOffset)
{
	...
	{
		UGSALSDebugComponent::DrawDebugLineTraceSingle(
			World,
			TraceStart,
			TraceEnd,
...
void UGSALSCharacterAnimInstance::RotateInPlaceCheck()
{
...
void UGSALSCharacterAnimInstance::TurnInPlaceCheck(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::DynamicTransitionCheck()
{
...
void UGSALSCharacterAnimInstance::UpdateMovementValues(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::UpdateRotationValues()
{
...
void UGSALSCharacterAnimInstance::UpdateInAirValues(float DeltaSeconds)
{
...
void UGSALSCharacterAnimInstance::UpdateRagdollValues()
{
...
float UGSALSCharacterAnimInstance::GetAnimCurveClamped(const FName& Name, float Bias, float ClampMin,
                                                     float ClampMax) const
{
	return FMath::Clamp(GetCurveValue(Name) + Bias, ClampMin, ClampMax);
}

FALSVelocityBlend UGSALSCharacterAnimInstance::CalculateVelocityBlend() const
{
...
FVector UGSALSCharacterAnimInstance::CalculateRelativeAccelerationAmount() const
{
...
float UGSALSCharacterAnimInstance::CalculateStrideBlend() const
{
...
float UGSALSCharacterAnimInstance::CalculateWalkRunBlend() const
{
...
float UGSALSCharacterAnimInstance::CalculateStandingPlayRate() const
{
...
float UGSALSCharacterAnimInstance::CalculateDiagonalScaleAmount() const
{
...
float UGSALSCharacterAnimInstance::CalculateCrouchingPlayRate() const
{
...
float UGSALSCharacterAnimInstance::CalculateLandPrediction() const
{
	...
	if (ALSDebugComponent && ALSDebugComponent->GetShowTraces())
	{
		UGSALSDebugComponent::DrawDebugCapsuleTraceSingle(World,
		                                                CapsuleWorldLoc,
...
FALSLeanAmount UGSALSCharacterAnimInstance::CalculateAirLeanAmount() const
{
...
EALSMovementDirection UGSALSCharacterAnimInstance::CalculateMovementDirection() const
{
...
void UGSALSCharacterAnimInstance::TurnInPlace(FRotator TargetRotation, float PlayRateScale, float StartTime,
...
void UGSALSCharacterAnimInstance::OnJumped()
{
	InAir.bJumped = true;
	...
	World->GetTimerManager().SetTimer(OnJumpedTimer, this,
	                                  &UGSALSCharacterAnimInstance::OnJumpedDelay, 0.1f, false);
}

void UGSALSCharacterAnimInstance::OnPivot()
{
	Grounded.bPivot = CharacterInformation.Speed < Config.TriggerPivotSpeedLimit;
	UWorld* World = GetWorld();
	check(World);
	World->GetTimerManager().SetTimer(OnPivotTimer, this,
	                                  &UGSALSCharacterAnimInstance::OnPivotDelay, 0.1f, false);
}
