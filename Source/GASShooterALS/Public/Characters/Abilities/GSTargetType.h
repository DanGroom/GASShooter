...
class GASSHOOTERALS_API UGSTargetType : public UObject
{
	GENERATED_BODY()
...
class GASSHOOTERALS_API UGSTargetType_UseOwner : public UGSTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class GASSHOOTERALS_API UGSTargetType_UseEventData : public UGSTargetType
{
	GENERATED_BODY()
