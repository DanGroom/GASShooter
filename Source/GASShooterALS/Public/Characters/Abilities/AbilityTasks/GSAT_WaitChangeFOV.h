 ...
 */
UCLASS()
class GASSHOOTERALS_API UGSAT_WaitChangeFOV : public UAbilityTask
{
	...
	static UGSAT_WaitChangeFOV* WaitChangeFOV(UGameplayAbility* OwningAbility, FName TaskInstanceName, class AGSCharacterBase* AffectedCharacter, float TargetFOV, float Duration, UCurveFloat* OptionalInterpolationCurve);
...
protected:
	...
	class AGSCharacterBase* Character;
