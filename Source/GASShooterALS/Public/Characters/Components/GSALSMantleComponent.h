...
#include "GSALSMantleComponent.generated.h"

// forward declarations
class UGSCharacterBase;
class UGSALSDebugComponent;


UCLASS(Blueprintable, BlueprintType)
class GASSHOOTERALS_API UGSALSMantleComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UGSALSMantleComponent();
...
protected:
	...
	UTimelineComponent* MantleTimeline2 = nullptr;
