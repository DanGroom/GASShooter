...
#include "GSALSCharacterAnimInstance.generated.h"
...
class GASSHOOTERALS_API UGSALSCharacterAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
protected:
	...
	AGSCharacterBase* Character = nullptr;
