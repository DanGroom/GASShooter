 ...
 */
UCLASS()
class GASSHOOTERALS_API AGSPlayerState : public APlayerState, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GASShooterALS|GSPlayerState")
	bool IsAlive() const;

	UFUNCTION(BlueprintCallable, Category = "GASShooterALS|GSPlayerState|UI")
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "GASShooterALS|GSPlayerState|Attributes")
